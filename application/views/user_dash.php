...
switch($currTime){
  case $currTime >=5 && $currTime <=11:
    ...
    $icon = '<i class="icon-sun mr-2"></i>';
  break;
  case $currTime >=12 && $currTime <=18:
    $greeting ='Good Afternoon';
    $icon ='<i class="icon-cloud mr-2"></i>';
  break; 
  case $currTime >=19 || $currTime <=4:
    $greeting ='Good Evening';
    $icon='<i class="icon-moon mr-2"></i>';
  break; 
  default:
  $greeting='No Timezone Set'; 
break; 
}
?>
<!DOCTYPE html>
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="<?php echo base_url();?>skydash/images/logo.svg" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="<?php echo base_url();?>skydash/images/logo-mini.svg" alt="logo"/></a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="<?php echo base_url();?>skydash/images/faces/face28.jpg" alt="profile"/>
            </a>
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Welcome <?php echo $_SESSION['email'];?></h3>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card tale-bg">
                <div class="card-people mt-auto">
                  <img src="<?php echo base_url();?>skydash/images/dashboard/people.svg" alt="people">
                  <div class="weather-info">
                    <div class="d-flex">
                      <div>
                        <h2 class="mb-0 font-weight-normal"><?php echo $icon;?></h2>
                      </div>
                      <div class="ml-2">
                        <h4 class="location font-weight-normal"><?php echo $greeting; ?></h4>
                      </div>
                    </div>
                  </div>
                </div>
