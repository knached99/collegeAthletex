...
class Admin extends CI_Controller{
  public function __construct(){
    ...
    if(!isset($_SESSION['username'])){
      redirect('../index.php/Admin_Login/admin_signin');
  ...
  public function admin_dash(){
    ...
    $this->load->view('admin', $data);
		if(!isset($_SESSION['username'])){
			redirect('localhost:8888/collegeAthletex/index.php/App/admin_login');
		}
	}
  ...
  public function acknowledge($user_id){
    ...
    if($acknowledged == TRUE){
      redirect('localhost:8888/collegeAthletex/index.php/Admin/admin_dash');
    }
    else{
